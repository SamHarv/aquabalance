...
class _TankInventoryViewState extends State<TankInventoryView> {
  ...
  Future<void> _loadSavedData() async {
    try {
      ...
      _showAlertDialog("Error loading saved data: $e");
      _initialiseTanks();
      setState(() {
        isLoading = false;
      });
                ...
                InputFieldWidget(
                  ...
                  onChanged: (value) {
                    try {
                      ...
                      _showAlertDialog("Please enter a number (litres)");
                  ...
                  InputFieldWidget(
                    ...
                    onChanged: (value) {
                      try {
                        ...
                        _showAlertDialog("Please enter a number (metres)");
